            ...
            if (type == "Current Staffs") {
                ...
                while (rs.next()) {
                    ...
                    StaffTableModel staff = new StaffTableModel(rs.getInt("empNo"),rs.getString("teacherName"),rs.getString("nic"),
                            rs.getString("dob"),rs.getString("doa"),rs.getString("gender"),rs.getString("email"),
                            rs.getString("phone"),rs.getString("address"),rs.getString("prsntGrade"));
                    staffList.add(staff);
                }
            }
            else {
    ...
    void print(ActionEvent event) {
        ...
        try {
          ...
          /*  HashMap<String,Object> Logo = new HashMap<String, Object>();
            ...
            URL url = this.getClass().getClassLoader().getResource("other/img/HikmaLogo.jpg");
            Logo.put("logo", url);*/
